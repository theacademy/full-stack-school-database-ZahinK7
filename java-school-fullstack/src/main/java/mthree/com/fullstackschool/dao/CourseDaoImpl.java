...
public class CourseDaoImpl implements CourseDao {
    ...
    public List<Course> getAllCourses() {
        ...
        final String SELECT_ALL_TEACHERS = "SELECT * FROM course";
        return jdbcTemplate.query(SELECT_ALL_TEACHERS, new CourseMapper());
    ...
    public void deleteCourse(int id) {
        ...
        String DELETE_COURSE = "DELETE FROM course WHERE cid = ?";
